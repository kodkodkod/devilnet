...
deadkontakt is an open source social networking platform written in Ruby on Rails. Here is the blog post: [How to build a social network using Rails](https://medium.com/@sudharshanmuralidharaniyer/eb31da569233).

Do you want to see it in action? Here is a working version deployed to heroku [http://deadkontaktapp.herokuapp.com](http://deadkontaktapp.herokuapp.com)
...
```
git clone https://github.com/sudharti/deadkontakt
cd deadkontakt
```
...
### Issues
If you find any issue with the app please do raise an issue here https://github.com/sudharti/deadkontakt/issues

### License
This project is Licensed under the [GNU GPL V2](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html). See  [LICENSE](https://github.com/sudharti/deadkontakt/blob/master/LICENSE) for more info.
